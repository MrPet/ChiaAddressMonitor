...
object Constants {
    ...
    val ALL_THE_BLOCKS_CURRENCIES = mapOf(
        ...
        "xeq" to CoinInfo("equality", "XEQ", "Equality", 1000000000000.0),
        ...
        "srn" to CoinInfo("shamrock", "SRN", "Shamrock", 1000000000000.0),
        ...
        "llc" to CoinInfo("littlelambocoin", "LLC", "LittleLamboCoin", 1000000000000.0),
